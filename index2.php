...
<div id="myCarousel" class="carousel slide homCar">
		<div class="carousel-inner" style="border-top:18px solid #222; border-bottom:1px solid #222; border-radius:4px;">
		  <div class="item active">
			<img src="images/foto1.jpg" alt="#" style="min-height:250px; min-width:100%"/>
		  ...
		  <div class="item">
			<img src="images/topo.jpg" alt="#" style="min-height:250px; min-width:100%"/>
			<div class="carousel-caption">
				  <h4>Topografía</h4>
				  <p>
		  ...
		  <div class="item">
			<img src="images/algebra1.jpg" alt="#" style="min-height:250px; min-width:100%"/>
			<div class="carousel-caption">
...
<div class="row" style="text-align:center">
			<div class="span2">
				<div class="well well-small">
					...
					<a href="pronto.php"><small>Ver detalles</small></a>
				</div>
			</div>
...
<div class="row">
	...
	<div class="span6">
	<div class="well well-small">
		<h3 align="center"> Lo que vendrá</h3>
		<h5>Nuevos cursos</h5>	
		<p align="justify">
		Estamos constantemente trabajando para la creación de nuevos cursos de calidad en los ambitos de ingeniería, podra encontrarlos más adelante en un periodo de 3 meses
...
<hr class="soften"/>
<p>&copy; Facultad de Ingeniería Mecanica y Electrica <br/><br/></p>
 </footer>
</div><!-- /container -->
