...
<body background="images/1.jpeg" style="background-attachment: fixed" >
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      <label style="font-size: 14pt"><b>Ingresa tu matricula</b></label>
      <input type="text" name="realname" class="form-control" placeholder="Matricula" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt; color: #FFFFFF;"><b>Ingresa tu correo institucional</b></label>
      <input type="text" name="nick" class="form-control"  required placeholder="ejemplo@uanl.mx"/>
    </div>
    <div class="form-group">
